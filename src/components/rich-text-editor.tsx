...
export function RichTextEditor({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: cn(
          "min-h-[200px] w-full px-3 py-2 text-base outline-none prose prose-sm sm:prose-base max-w-full",
  ...
  return (
    <div className={cn("border border-input rounded-lg overflow-hidden focus-within:border-ring focus-within:ring-1 focus-within:ring-ring transition-all", className)}>
