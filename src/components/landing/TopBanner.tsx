...
import { ArrowLeft, ArrowRight, Building2, ChevronDown, ChevronUp, Sparkles } from "lucide-react";
			...
			<AnimatePresence mode="wait">
				{isExpanded ? (
					...
					>
						...
						<div className="absolute -inset-1 bg-linear-to-r from-amber-500/20 via-orange-500/20 to-rose-500/20 rounded-2xl blur-xl opacity-70" />
						...
						<div className="relative overflow-hidden rounded-xl border border-white/10 bg-linear-to-br from-zinc-900 via-zinc-800 to-zinc-900 shadow-2xl">
							...
							<div className="absolute inset-0 bg-linear-to-r from-amber-500/10 via-orange-500/10 to-rose-500/10 opacity-50" />
							...
							<Link href="/hire" className="relative block p-4 pe-8 group">
								{/* Badge */}
								<div className="flex items-center gap-1.5 mb-2">
									<span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-linear-to-r from-amber-500/20 to-orange-500/20 border border-amber-500/30">
										<Sparkles className="h-3 w-3 text-amber-400" />
										<span className="text-[10px] font-semibold uppercase tracking-wider text-amber-300">
											{t("topBanner.badge", "For Companies")}
										</span>
									</span>
								</div>
								...
								<div className="flex items-center gap-3">
									<div className="shrink-0 p-2 rounded-lg bg-linear-to-br from-amber-500/20 to-orange-600/20 border border-amber-500/20">
					...
					>
						...
						<div className="relative group">
							...
							>
								<div className="p-1.5 rounded-full bg-linear-to-br from-amber-500/20 to-orange-600/20 border border-amber-500/20">
									<Building2 className="h-4 w-4 text-amber-400" />
								</div>
								<span className="text-xs font-medium text-zinc-300 hidden sm:inline">
									{t("topBanner.badge", "For Companies")}
								</span>
								<ChevronUp className="h-3.5 w-3.5 text-zinc-500 group-hover:text-amber-400 transition-colors" />
							</button>
						</div>
					</motion.div>
				)}
