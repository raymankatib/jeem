...
export function HireFAQSection() {
	...
	const faqItems = t("hire.faq.items", { returnObjects: true }) as Array<{ question: string; answer: string }>;
						...
						<motion.div variants={fadeInUp} className="lg:col-span-4">
							<div className="lg:sticky lg:top-24">
								<p className="text-sm text-muted-foreground uppercase tracking-wider mb-3">
									{t("hire.faq.sectionLabel")}
								</p>
								<h2 className="text-3xl sm:text-4xl font-semibold tracking-tight mb-4">{t("hire.faq.title")}</h2>
								<p className="text-muted-foreground leading-relaxed">{t("hire.faq.description")}</p>
							</div>
						</motion.div>
